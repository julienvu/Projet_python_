...
class Stage1(RelativeLayout):
    ...
    def delete_all_game_widgets(self):
        print("delete_all_game_widgets")
        ...
        if self.cloud is not None:
            ...
            self.cloud = None
        if self.drop_list is not None and len(self.drop_list) != 0:
    ...
    def update(self, dt):
        ...
        if self.game_start:
            ...
            if self.counter >= self.cloud_speed:
                ...
                # print("update_cloud_and_create_drop")
